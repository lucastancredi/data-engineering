...
class MercadoBitcoinApi(ABC):
    ...
    #esse metodo torna obrigatório a implementação do _get_endpoint
    @abstractmethod
...
class TradesApi(MercadoBitcoinApi):
    ...
    #esse metodo é pra não ferir o principio de responsabilidade única quando se converte o tipo da data na def abaixo
